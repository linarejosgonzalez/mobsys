package com.example.determinemovementandroid33;
...
public class MainActivity extends Activity//extends SpeechRecognizingAndSpeakingActivity
{
    private static final String TAG = "DetermineMovAct";
    ...
    */
    ...
    private void startReadingAccelerationData()
    {
        if (!readingAccelerationData)
        {
            ...
            sensorManager.registerListener(accelerometerListener,sensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER), RATE);
            sensorManager.registerListener(linearAccelerationListener, sensorManager.getDefaultSensor(Sensor.TYPE_LINEAR_ACCELERATION), RATE);
